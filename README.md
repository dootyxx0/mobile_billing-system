...
Учебный проект по курсу «Базы данных» (ИТМО, факультет ФТМИ).
Ученик: Казанцев Семён Викторович 
ИСУ: 466074
Спроектирована и реализована модель данных для упрощённого аналога BSS-системы (Business Support System) — той категории продуктов, которую разрабатывают компании уровня Nexign для операторов связи.
...
Все скрипты протестированы на PostgreSQL 16.

## Стек

PostgreSQL · PL/pgSQL · DBeaver

## Автор

Семён Казанцев, ИТМО, ФТМИ, факультет «Бизнес-информатика»
